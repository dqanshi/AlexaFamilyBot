...
from haruka import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, OWNER_NAME, ALLOW_EXCL, telethn,pbot
...
PM_START_TEXT = """
_Hello_ *{}*
_My name is_ *{}*\n_A Pσɯҽɾϝυʅ Tҽʅҽɠɾαɱ ρɾσႦσƚ ƚσ ɱαɳαɠҽ ყσυɾ ɠɾσυρʂ ƈσσʅ!!_
